...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get("http://docker-alb-be-126085413.us-west-2.elb.amazonaws.com:9090/user/profile", {
          headers: {
    ...
    fetchBlogs("http://docker-alb-be-126085413.us-west-2.elb.amazonaws.com:9090/blogs", token);
    fetchForums("http://docker-alb-be-126085413.us-west-2.elb.amazonaws.com:9090/forums", token);
    fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch("http://docker-alb-be-126085413.us-west-2.elb.amazonaws.com:9090/user/update-profile", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
