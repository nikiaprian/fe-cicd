...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        .get("http://internal-docker-alb-be-623785321.us-west-2.elb.amazonaws.com:9090/user/profile", {
          headers: {
    ...
    fetchBlogs("http://internal-docker-alb-be-623785321.us-west-2.elb.amazonaws.com:9090/blogs", token);
    fetchForums("http://internal-docker-alb-be-623785321.us-west-2.elb.amazonaws.com:9090/forums", token);
    fetchData();
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .patch("http://internal-docker-alb-be-623785321.us-west-2.elb.amazonaws.com:9090/user/update-profile", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
