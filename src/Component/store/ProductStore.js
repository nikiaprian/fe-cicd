...
const storeBlog = (set) => ({
  ...
  fetchSetComment: async (id) => {
    await axios
      .get(`docker-alb-be-510000286.us-west-2.elb.amazonaws.com/comments/${id}`, {
        headers: {
          "Content-Type": "application/json",
        },
      })
  ...
  fetchCommentInput: async (id, data, token) => {
    await axios
      .post(`docker-alb-be-510000286.us-west-2.elb.amazonaws.com/comments/${id}`, data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
...
const storeForum = (set) => ({
  ...
  fetchForums: async (token) => {
    await axios
      .get("docker-alb-be-510000286.us-west-2.elb.amazonaws.com/forums", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
  ...
  fetchsetAnswer: async (id, key) => {
    await axios
      .get(`docker-alb-be-510000286.us-west-2.elb.amazonaws.com/commentsforum/${id}`, {
        headers: {
          "Content-Type": "application/json",
  ...
  fetchAnswerInput: async (id, data, token) => {
    await axios
      .post(`docker-alb-be-510000286.us-west-2.elb.amazonaws.com/commentsforum/${id}`, data, {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
